      ...
      <div className="body-container">
        ...
        <div className="body-main-icons">
          <div className="twitter-icon" 
               ...
               >
            <Link to="/tweets">
              <img src={twitterBcg} alt="twitter_logo" width="135" height="135"/>
            </Link>
            <p className={twitterBcg==='twitter.png' ? 'twitter-inactive' : 'twitter-active'}>Tweet</p>
          </div>
          <div className="globe-icon"
            ...
            <p className={globeBcg==='globe.png' ? 'globe-inactive' : 'globe-active'}>URL</p>
          </div>
        </div>
      </div>
    </>
